...
class TestAttendanceSystem(unittest.TestCase):
    ...
    def test_new_attendance_from_user(self, mock_input):
        ...
        # Assert
        self.attendance_system.record_attendance.assert_called_once_with("123", "A")
    ...
    def test_record_attendance(self, mock_datetime):
        ...
        # Assert
        self.attendance_system.record_attendance_time.assert_called_once_with(emp_id, status, expected_time)
